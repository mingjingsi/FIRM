...
// FIRM_res_all
RcppExport SEXP FIRM_res_all(arma::mat& SS2, arma::mat& SS2_FindClusters, arma::mat& tenx, arma::mat& tenx_FindClusters, const int dims, double quantile_default, const int rept_ds, const int k, const int max_k, const int coreNum);
RcppExport SEXP _FIRM_FIRM_res_all(SEXP SS2SEXP, SEXP SS2_FindClustersSEXP, SEXP tenxSEXP, SEXP tenx_FindClustersSEXP, SEXP dimsSEXP, SEXP quantile_defaultSEXP, SEXP rept_dsSEXP, SEXP kSEXP, SEXP max_kSEXP, SEXP coreNumSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat& >::type SS2(SS2SEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(FIRM_res_all(SS2, SS2_FindClusters, tenx, tenx_FindClusters, dims, quantile_default, rept_ds, k, max_k, coreNum));
    return rcpp_result_gen;
END_RCPP
}
// FIRM_res_hvg
